...
syntax region  javaScriptStringD        matchgroup=javaScriptStringDelimiter start=+"+  skip=+\\\\\|\\$"+  end=+"+  contains=javaScriptSpecial,@htmlPreproc
syntax region  javaScriptStringS        matchgroup=javaScriptStringDelimiter start=+'+  skip=+\\\\\|\\$'+  end=+'+  contains=javaScriptSpecial,@htmlPreproc

syntax match   javaScriptRegexpSpecial  "\\\d\d\d\|\\x\x\{2\}\|\\u\x\{4\}\|\\." contained display
syntax region  javaScriptRegexpString   matchgroup=javaScriptRegexpDelimiter start=+/\(\*\|/\)\@!+ skip=+\\\\\|\\/+ end=+/[gim]\{,3}+ contains=javaScriptRegexpSpecial,@htmlPreproc oneline
...
syntax keyword javaScriptIdentifier     const var
...
"" Code blocks
syntax cluster javaScriptAll       contains=javaScriptComment,javaScriptLineComment,javaScriptDocComment,javaScriptStringD,javaScriptStringS,javaScriptRegexpString,javaScriptNumber,javaScriptFloat,javaScriptLabel,javaScriptSource,javaScriptType,javaScriptIdentifier,javaScriptOperator,javaScriptBoolean,javaScriptNull,javaScriptFunction,javaScriptConditional,javaScriptRepeat,javaScriptBranch,javaScriptStatement,javaScriptGlobalObjects,javaScriptExceptions,javaScriptFutureKeys,javaScriptDomErrNo,javaScriptDomNodeConsts,javaScriptHtmlEvents,javaScriptDotNotation
...
if version >= 508 || !exists("did_javascript_syn_inits")
  ...
  HiLink javaScriptStringDelimiter      String
